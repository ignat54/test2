...
if st.button("Рассчитать риск"):
    if -1 in form_data.values():
        ...
        if total_score <= 3:
            ...
            st.warning("Вам стоит пересмотреть свой образ жизни и **планово обратиться за консультацией к врачу-терапевту**.")
        else:
            st.error("Вам следует **как можно скорее обратиться за консультацией к врачу-терапевту!**")